...
run bash scripts/digestaste-smoke.sh --fixtures
...
run bash scripts/agent-view-smoke.sh --fixtures
run bash scripts/goal-mode-smoke.sh --fixtures
run bash scripts/specqa-smoke.sh --fixtures
