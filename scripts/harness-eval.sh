...
def normalize_gate(value: str) -> str:
    ...
    aliases = {
        ...
        "bash scripts/demo-smoke.sh --fixtures": "demo-smoke",
        ...
        "digestaste-smoke": "digestaste-smoke",
        "scripts/digestaste-smoke.sh": "digestaste-smoke",
        "scripts/digestaste-smoke.sh --fixtures": "digestaste-smoke",
        "bash scripts/digestaste-smoke.sh --fixtures": "digestaste-smoke",
        ...
        "opusworkflow-smoke": "opusworkflow-smoke",
        "scripts/opusworkflow-smoke.sh": "opusworkflow-smoke",
        "bash scripts/opusworkflow-smoke.sh": "opusworkflow-smoke",
        ...
        "agent-view-smoke": "agent-view-smoke",
...
run_gate() {
  ...
  case "$gate" in
    ...
    "defineicp-smoke")
      ...
      ;;
    "digestaste-smoke")
      require_gate_script "scripts/digestaste-smoke.sh" || return $?
      bash "$ROOT_DIR/scripts/digestaste-smoke.sh" --fixtures
      ;;
    "deepretaste-smoke")
    ...
    "opusminimax-benchmark-smoke")
      ...
      ;;
    "opusworkflow-smoke")
      require_gate_script "scripts/opusworkflow-smoke.sh" || return $?
      bash "$ROOT_DIR/scripts/opusworkflow-smoke.sh"
      ;;
    "remote-control-smoke")
