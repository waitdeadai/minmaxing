...
[ "$SKILL_COUNT" -ge 30 ] || fail "expected at least 30 skills, found $SKILL_COUNT"
...
require_grep "30 skills" README.md
require_grep "Expected 30 skills" scripts/start-session.sh
