...
[ "$SKILL_COUNT" -ge 29 ] || fail "expected at least 29 skills, found $SKILL_COUNT"
...
require_grep "29 skills" README.md
require_grep "Expected 29 skills" scripts/start-session.sh
