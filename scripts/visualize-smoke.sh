...
[ "$SKILL_COUNT" -ge 33 ] || fail "expected at least 33 skills, found $SKILL_COUNT"
...
require_grep "33 skills" README.md
require_grep "Expected 33 skills" scripts/start-session.sh
