...
[ "$SKILL_COUNT" -ge 27 ] || fail "expected at least 27 skills, found $SKILL_COUNT"
...
require_grep "27 skills" README.md
require_grep "Expected 27 skills" scripts/start-session.sh
