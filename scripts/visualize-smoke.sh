...
[ "$SKILL_COUNT" -ge 36 ] || fail "expected at least 36 skills, found $SKILL_COUNT"
...
require_grep "36 skills" README.md
require_grep "Expected 36 skills" scripts/start-session.sh
