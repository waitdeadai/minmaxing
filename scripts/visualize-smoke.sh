...
[ "$SKILL_COUNT" -ge 25 ] || fail "expected at least 25 skills, found $SKILL_COUNT"
...
require_grep "25 skills" README.md
require_grep "Expected 25 skills" scripts/start-session.sh
