...
[ "$SKILL_COUNT" -ge 37 ] || fail "expected at least 37 skills, found $SKILL_COUNT"
...
require_grep "37 skills" README.md
require_grep "Expected 37 skills" scripts/start-session.sh
