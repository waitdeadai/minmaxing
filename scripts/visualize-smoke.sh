...
[ "$SKILL_COUNT" -ge 34 ] || fail "expected at least 34 skills, found $SKILL_COUNT"
...
require_grep "34 skills" README.md
require_grep "Expected 34 skills" scripts/start-session.sh
