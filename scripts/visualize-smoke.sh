...
[ "$SKILL_COUNT" -ge 35 ] || fail "expected at least 35 skills, found $SKILL_COUNT"
...
require_grep "35 skills" README.md
require_grep "Expected 35 skills" scripts/start-session.sh
