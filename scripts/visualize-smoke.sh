...
[ "$SKILL_COUNT" -ge 28 ] || fail "expected at least 28 skills, found $SKILL_COUNT"
...
require_grep "28 skills" README.md
require_grep "Expected 28 skills" scripts/start-session.sh
